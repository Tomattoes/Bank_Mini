                                    ...
                                    foreach ($pengguna1 as $p) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url(); ?>admin/hapus/<?= $p['id_pengguna']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i class="fa-solid fa-trash-can"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
            ...
            <div class="modal-dialog modal-xs">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" action="<?= base_url(); ?>Admin/add">
                            <div class="card-body">
