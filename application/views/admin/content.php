     ...
     <div class="container-fluid">
       ...
       <div class="row">
         <div class="col-6 col-sm-6 col-md-3">
           <a href="<?= base_url(); ?>admin/data_user" class="text-dark">
             <div class="info-box">
         ...
         <!-- ./col -->
         <div class="col-6 col-sm-6 col-md-3">
           <a href="<?= base_url(); ?>admin/teller" class="text-dark">
             <div class="info-box">
               <span class="info-box-icon bg-danger elevation-1"><i class="fa-solid fa-user-nurse"></i></span>
         ...
         <!-- ./col -->
         <div class="col-6 col-sm-6 col-md-3">
           <a href="<?= base_url(); ?>admin/cs" class="text-dark">
             <div class="info-box">
               <span class="info-box-icon bg-secondary elevation-1"><i class="fa-solid fa-user-gear"></i></span>
         ...
         <!-- ./col -->
         <div class="col-6 col-sm-6 col-md-3">
           <a href="<?= base_url(); ?>admin/pimpinan" class="text-dark">
             <div class="info-box">
       ...
       <div class="row">
         <div class="col-6 col-sm-6 col-md-3">
           <a href="<?= base_url(); ?>admin/kelas" class="text-dark">
             <div class="info-box">
         ...
         <div class="col-6 col-sm-6 col-md-3">
           <a href="<?= base_url(); ?>admin/jurusan" class="text-dark">
             <div class="info-box">
               <span class="info-box-icon bg-primary elevation-1"><i class="fa-solid fa-graduation-cap"></i></span>
       ...
       <div class="row">
         ...
         <div class="col-6 col-sm-6 col-md-4">
           <div class="info-box">
             <span class="info-box-icon bg-danger elevation-1"><i class="fa-solid fa-hand-holding-dollar"></i></span>
             <div class="info-box-content">
               <span class="info-box-text">Total Penarikan</span>
               <span class="info-box-number">
                 <?php
                  foreach ($penarikan as $tr) : ?>
                   <h4>
                     <?php
                      $nilai_mata_uang = $tr['Penarikan'];
                      $format_mata_uang = number_format($nilai_mata_uang, 0, ',', '.');
                      echo 'Rp ' . $format_mata_uang;
                      ?>
                   </h4>
