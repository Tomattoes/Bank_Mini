<div class="content-wrapper">
    ...
    <section class="content">
                                ...
                                <tbody>
                                    ...
                                    foreach ($pimpinan as $h) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a data-toggle="modal" data-target="#edit<?= $h['id_pengguna']; ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pencil"></i></a>
                                                <a href="<?= base_url(); ?>admin/hapusCs/<?= $h['id_pengguna']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');"><i class="fa-solid fa-trash-can"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
            ...
            <div class="modal-dialog modal-xs">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" enctype="multipart/form-data" action="<?= base_url(); ?>Admin/addHrd">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="id">Id Pimpinan</label>
                                    <input type="text" name="id" class="form-control" id="id" placeholder="ID Pimpinan" autofocus value="<?= set_value('id'); ?>">
                                </div>
        ...
        $no = 1;
        foreach ($pimpinan as $h) : ?>
            <div class="modal" id="edit<?= $h['id_pengguna']; ?>">
                <div class="modal-dialog modal-xs">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form method="POST" enctype="multipart/form-data" action="<?= base_url(); ?>Admin/editHrd">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="id">ID Pimpinan</label>
                                        <input type="text" name="id" class="form-control" id="id" value="<?= $h['id_pengguna']; ?>" readonly>
                                    </div>
                                    <small class="form-text text-danger"><?= form_error('id'); ?></small>
                                    <div class="form-group">
                                        <label for="nm">Nama</label>
                                        <input type="text" name="nm" class="form-control" id="nm" value="<?= $h['nm_pg']; ?>">
                                    </div>
                                    <small class="form-text text-danger"><?= form_error('nm'); ?></small>
                                    <div class="form-group">
                                        <label for="no_hp">No Hp</label>
                                        <input type="text" name="no_hp" class="form-control" id="no_hp" value="<?= $h['no_hp']; ?>">
                                    </div>
                                    <small class="form-text text-danger"><?= form_error('no_hp'); ?></small>
                                    <div class="form-group">
                                        <label for="alamat">Alamat</label>
                                        <input type="text" name="alamat" class="form-control" id="alamat" value="<?= $h['alamat']; ?>">
                                    </div>
                                    <small class="form-text text-danger"><?= form_error('alamat'); ?></small>
                                </div>
                                <!-- /.card-body -->
