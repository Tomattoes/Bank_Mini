       ...
       <div class="row">
         <div class="col col-sm-6 col-md-4">
           <div class="info-box">
             ...
             <div class="info-box-content">
               <span class="info-box-text">Total<br>Ajuan Permintaan</span>
         ...
         <div class="col-6 col-sm-6 col-md-4">
           <div class="info-box">
             ...
             <div class="info-box-content">
               <span class="info-box-text">Ajuan Permintaan<br>Disetujui</span>
               <span class="info-box-number">
                 <?= $user; ?>
                 <small>siswa</small>
               </span>
         ...
         <div class="col-6 col-sm-6 col-md-4">
           <div class="info-box">
             ...
             <div class="info-box-content">
               <span class="info-box-text">Ajuan Permintaan<br>Belum Disetujui</span>
               <span class="info-box-number">
                 <?= $user; ?>
                 <small>siswa</small>
               </span>
